...
| **InjectCheck** | Process Injection Checker. The tool enumartes the Hardened Runtime, Entitlements, and prescense of Electron files to determine possible injection opportunities | js_importcall InjectCheck("All") <br /> or <br /> InjectCheck("/Applications/Firefox.app") | N/A | N/A |
